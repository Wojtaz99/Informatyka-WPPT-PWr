...
"""
function zad1(type_arg)
	# Zadany wektor x z zadania
	a::Vector{type_arg} = [2.718281828, -3.141592654, 1.414213562, 0.577215664, 0.301029995]
	# Zadany wektor y z zadania
	b::Vector{type_arg} = [1486.2497, 878366.9879, -22.37492, 4773714.647, 0.000185049]
	# Wektor po wymnożeniu ai * bi
	c::Vector{type_arg} = a .* b 
